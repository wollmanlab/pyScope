...
class PurpleFluidics(Fluidics):
    """Purple-specific fluidics implementation.
    
    Configures Purple system with specific COM ports, valve mappings, and
    ...
    def __init__(self, gui=False):
        """Initialize PurpleFluidics with Purple-specific configuration.
        ...
        self.Protocol.speed = 1#1
        self.Protocol.max_speed = 1#1
