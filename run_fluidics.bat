...
if exist "C:\Users\wollmanlab\miniconda3\envs\pyscope_3.12\python.exe" (
    "C:\Users\wollmanlab\miniconda3\envs\pyscope_3.12\python" -m Fluidics.fluidics
) else if exist "C:\Users\wollmanlab\miniconda3\envs\pycro_3.12\python.exe" (
    "C:\Users\wollmanlab\miniconda3\envs\pycro_3.12\python" -m Fluidics.fluidics
) else if exist "C:\Users\wollmanlab\.conda\envs\pyscope_3.12\python.exe" (
    "C:\Users\wollmanlab\.conda\envs\pyscope_3.12\python" -m Fluidics.fluidics
) else if exist "C:\Users\wollmanlab\.conda\envs\pycro_3.12\python.exe" (
    "C:\Users\wollmanlab\.conda\envs\pycro_3.12\python" -m Fluidics.fluidics
) else (
